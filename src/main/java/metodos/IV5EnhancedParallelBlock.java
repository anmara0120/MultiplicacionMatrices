...
public class IV5EnhancedParallelBlock extends TiempoEjecucion {
    @Override
    public double[][] algoritmo(double[][] matriz) {
        nombreMetodo = "IV5EnhancedParallelBlock";
        return alg_IV_5_Enhanced_Parallel_Block(matriz);
    }

    public static double[][] alg_IV_5_Enhanced_Parallel_Block(double[][] matriz) {
        int size;
        size = matriz.length;
