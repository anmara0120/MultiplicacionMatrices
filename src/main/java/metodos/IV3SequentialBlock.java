...
public class IV3SequentialBlock extends TiempoEjecucion {
    @Override
    public double[][] algoritmo(double[][] matriz) {
        nombreMetodo = "IV3SequentialBlock";
        return lV_3SequentialBlock(matriz);
    }

    public double[][] lV_3SequentialBlock(double [][] matriz){
